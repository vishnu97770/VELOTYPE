...
function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            formData.append('username', loginData.email);   // backend uses 'username' field
            ...
            // Redirect to typing test after login
        ...
        <div className="login-page">
            ...
            <main>
                ...
                <div className="form-column">
                    ...
                    {registerError   && <p style={{ color: '#ca4754', fontSize: '0.85rem', marginBottom: '0.5rem' }}>{registerError}</p>}
                    {registerSuccess && <p style={{ color: '#3ab76a', fontSize: '0.85rem', marginBottom: '0.5rem' }}>{registerSuccess}</p>}
                ...
                <div className="form-column">
                    ...
                    {/* Error message */}
                    {loginError && <p style={{ color: '#ca4754', fontSize: '0.85rem', marginBottom: '0.5rem' }}>{loginError}</p>}
